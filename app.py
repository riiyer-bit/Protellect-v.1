...
with tab2:
    ...
    st.caption("Critical distinction: Is this protein a DIRECT disease driver, or does it merely look disease-relevant because it associates with GPCRs?")
    ...
    if diseases:
        ...
        st.caption(f"Each disease linked to {gene} with mutation type, inheritance, severity estimate, and impact bars. Source: UniProt + ClinVar.")
